...
function resetForm(){q('form').reset(); q('recordId').value=''; q('deviceSearch').readOnly=false; CURRENT_INSPECTION_FILE_PATH=''; if(q('fileUpload')) q('fileUpload').value=''; fillInfo();}
